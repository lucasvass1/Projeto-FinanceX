...
import { TRANSACTION_PAYMENT_METHOD_ICONS } from "@/app/_constants/constants";

import { formatCurreny } from "@/app/_utils/currency";
        ...
        {lastTransactions.map((transaction) => (
          ...
          >
            ...
            <p className={`text-sm font-bold ${getAmountColor(transaction)}`}>
              ...
              {formatCurreny(Number(transaction.amount))}
            </p>
          </div>
        ))}
      </CardContent>
